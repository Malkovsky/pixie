...
можно реализовать вторую операцию (в нашем случае ```select0```) без дополнительной памяти но с замедлением в $ \approx 1.5 $ раза.
...
Level Order Unary Degree Sequence - сжатое представление дерева в виде последовательности битов длины $ 2*n - 1 $.
